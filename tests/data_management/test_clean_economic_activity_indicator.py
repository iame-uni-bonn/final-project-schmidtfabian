...
test_dictionary_wrong_columns =  {"Datum gestern": ["25.02.2024", "26.02.2024", "27.02.2024"],
...
test_dictionary_correct_columns =  {"Datum": ["25.02.2024", "26.02.2024", "27.02.2024"],
...
def test_clean_economic_indicator_rename():
    ...
    "Column 'values' is not in the DataFrame, or columns 'Datum' or 'Kalender- und saisonbereinigt (KSB)' still exist in the DataFrame."

def test_clean_economic_indicator_correct_index():
    cleaned_data = clean_economic_activity_indicator(test_dataframe_correct_columns)
    index_values_datetime = pd.to_datetime(["25.02.2024", "26.02.2024", "27.02.2024"],
