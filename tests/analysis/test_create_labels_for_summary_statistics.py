...
dataframe_wrong_column_text = pd.DataFrame({"incorrect_column": ["text1", "text2"], "label": [0, 1]})
dataframe_wrong_column_label = pd.DataFrame({"text": ["text1", "text2"], "no label": [0, 1]})
...
dataframe_label_not_int = pd.DataFrame({"text": ["text1", "text2"], "label": ["0", "1"]})
