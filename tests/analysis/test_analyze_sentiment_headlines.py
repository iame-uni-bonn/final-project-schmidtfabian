...
from final_project_schmidtfabian.analysis.analyze_sentiment_headlines import\
    analyze_sentiment_zero_shot_classification, analyze_sentiment_finetuned_model
...
test_dataframe_wrong_datatypes_elements = pd.DataFrame({'headlines in a list': [numbers]})
