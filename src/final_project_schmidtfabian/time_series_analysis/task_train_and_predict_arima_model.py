...
from final_project_schmidtfabian.time_series_analysis.train_arima_model import train_arima_model, \
create_summary_statistics_dataframe, create_predictions_dataframe_ARIMA_model
...
def task_train_and_predict_arima_model(
    ...
    ARIMA_model_summary_statistics_dataframe = create_summary_statistics_dataframe(ARIMA_model=ARIMA_model)
