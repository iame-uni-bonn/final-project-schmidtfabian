...
for category in ["cycle_values", "sentiment"]:
    adf_statistics_products = {
        "ADF statistic p-value": BLD
        / "output"
        / f"p_value_ADF_statistic_{category}.txt",
    }
    ...
    def task_calculate_adf_statistic(
        ...
        """Calculates p.value of ADF-statistic for cycle and sentiment values."""
        ...
        write_value_to_file(
            p_value_ADF_result_cycle_values,
            produces["ADF statistic p-value"],
        )
